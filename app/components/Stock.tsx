...
const Stock: FC = () => {
  ...
  return (
    <div>
      {/* Modale d'alimentation du stock */}
      <dialog id="my_modal_stock" className="modal">
        <div className="modal-box">
          <form method="dialog">
            {/* Bouton de fermeture de la modale */}
            <button type="button" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onClick={() => (document.getElementById('my_modal_stock') as HTMLDialogElement)?.close()} aria-label="Fermer">✕</button>
          </form>
